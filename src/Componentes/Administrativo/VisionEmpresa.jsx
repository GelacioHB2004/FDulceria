...
const VisionAdmin = () => {
  ...
  const obtenerVision = async () => {
    try {
      ...
      console.error("Error al obtener vision", error);
    }
  };
  ...
  const guardarVision = async () => {
    ...
    try {
      if (vision) {
        ...
        alert("Vision actualizada correctamente");
      } else {
        await axios.post(`${API_BASE_URL}/api/vision/crear`, {
          titulo,
          descripcion,
          id_empresa,
        });
        alert("Vision creada correctamente");
      }
      obtenerVision();
    } catch (error) {
      console.error("Error al guardar vision", error);
    }
  };
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, mb: 3 }}>
          ...
          <Box>
            ...
            >
              Define la vision de tu empresa
            </Typography>
          </Box>
          <Chip
            label="Admin"
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            <TextField
              label="Titulo"
              placeholder="Ingresa el titulo de la vision"
              value={titulo}
          ...
          >
            {vision ? "Actualizar Vision" : "Guardar Vision"}
          </Button>
        </Box>
