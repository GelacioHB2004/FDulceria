...
import { BadgeOutlined, CheckCircleOutline } from '@mui/icons-material';
...
function ValidarCodigo() {
  ...
  const inputStyles = {
    ...
    '& .MuiInputAdornment-root .MuiSvgIcon-root': { color: '#9ca3af' },
  };
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <CheckCircleOutline sx={{ fontSize: 32, color: '#16a34a' }} />
          </Box>
          <Typography variant="h6" fontWeight={800} sx={{ color: '#111827', mb: 1 }}>
            Codigo verificado
          </Typography>
          <Typography variant="body2" sx={{ color: '#6b7280', mb: 2 }}>
            El codigo es correcto. Preparando para establecer nueva contrasena...
          </Typography>
      ...
      >
        ...
        <Box sx={{ mb: 4, textAlign: 'center' }}>
          ...
          <Typography variant="body2" sx={{ color: '#6b7280' }}>
            Escribe el codigo de 6 digitos enviado a tu correo.
          </Typography>
        </Box>
