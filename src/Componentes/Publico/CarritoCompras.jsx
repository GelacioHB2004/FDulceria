...
const CarritoCompras = () => {
  ...
  const procesarCompra = () => {
    Swal.fire({
      icon: 'info',
      title: 'Inicia Sesion',
      text: 'Para realizar tu compra, necesitas iniciar sesion o registrarte.',
    });
  };
          ...
          <Fade in>
            ...
            >
              ...
              <Typography variant="body1" sx={{ color: colors.textLight, mb: 4 }}>
                Explora nuestro catalogo y encuentra productos deliciosos
              </Typography>
              <Button
                variant="contained"
                href="/productos"
              ...
              >
                ...
                <Box sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1.5 }}>
                    <Typography sx={{ color: colors.textLight }}>Subtotal</Typography>
